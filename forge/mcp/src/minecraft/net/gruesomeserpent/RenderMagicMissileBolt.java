...
public class RenderMagicMissileBolt extends Render {

  private static final ResourceLocation magicMissileTextures = new ResourceLocation("gruesomeserpent:textures/items/MagicMissileScroll.png");
